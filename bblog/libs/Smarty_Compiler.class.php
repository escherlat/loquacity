 ...
 * @package Smarty
 */
/* $Id: Smarty_Compiler.class.php,v 1.4 2004/01/08 13:04:44 eadz Exp $ */
...
class Smarty_Compiler extends Smarty {
	 ...
	 *
	 * @param string  $tag_args
	 * @param boolean $elseif   (optional) if true, uses elseif instead of if
	 * @return string
	 */
	 ...
	 * @param unknown $name
	 * @param unknown $attrs
	 * @param unknown $cache_code (reference)
	 * @return unknown
	 */
