 ...
 * @package Smarty
 */
/* $Id: Config_File.class.php,v 1.4 2004/01/08 13:04:44 eadz Exp $ */
...
class Config_File {
	 ...
	 *
	 * @param unknown $file_name string config key (filename/section/var)
	 ...
	 *
	 * @param string  $file_name config file to get info for
	 * @param unknown $section   (optional)
	 ...
	 *
	 * @param string  $file_name (optional) file to clear config data for
	 */
	 ...
	 * @param boolean $prepend_path (optional) whether current config path should be
	 * @return unknown
	 */
	 ...
	 * @param unknown $config_block
	 * @param unknown $triple_quotes
	 * @return unknown
	 */
	 ...
	 * @param integer $error_type (optional) one of
	 */
