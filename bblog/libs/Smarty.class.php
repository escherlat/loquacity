 ...
 * @version 2.6.0
 */
/* $Id: Smarty.class.php,v 1.4 2004/01/08 13:04:44 eadz Exp $ */
 ...
 */
	 ...
	 * @param mixed   $value   (reference) the referenced value to assign
	 */
	 ...
	 *
	 * @param array|string $tpl_var the template variable name(s)
	 * @param mixed   $value   (optional) the value to append
	 ...
	 *
	 * @param string  $tpl_var the template variable name
	 * @param mixed   $value   (reference) the referenced value to append
	 * @param unknown $merge   (optional)
	 */
	 ...
	 * @param unknown $cacheable     (optional)
	 * @param unknown $cache_attrs   (optional)
	 */
	 ...
	 * @param boolean $smarty_args   (optional) smarty argument format, else traditional
	 * @param unknown $block_methods (optional)
	 */
	 ...
	 *
	 * @param string  $tpl_file   (optional) name of template file
	 * @param string  $cache_id   (optional) name of cache_id
	 * @param string  $compile_id (optional) name of compile_id
	 * @param string  $exp_time   (optional) expiration time
	 * @return boolean
	 */
	 ...
	 *
	 * @param string  $exp_time (optional) expire time
	 ...
	 * @param unknown $cache_include_path (optional)
	 * @return boolean
	 */
	 ...
	 *
	 * @param unknown $params (reference)
	 * @return boolean
	 */
